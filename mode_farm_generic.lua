...
function GetDesire()	
	...
	then
		...
		local firstMessage = "(QQ交流群:244375519)天地星AI: "..sPushVersion..sVersionDate		
...
function X.SetPushBonus( bot )
	...
	local bonusNoticeTable = {	
		...
		["7.31Y3"] = "大神, 当前挑战的是三倍金钱经验夜魇AI(7.31).",
		["7.31Y2"] = "勇士, 当前挑战的是双倍金钱经验夜魇AI(7.31).",
		["7.31T2"] = "勇士, 当前挑战的是双倍金钱经验天辉AI(7.31).",
		["7.31Y1.5"] = "少年, 当前挑战的是1.5倍金钱经验夜魇AI(7.31).",	
